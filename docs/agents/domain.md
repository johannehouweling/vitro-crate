...
- **`CONTEXT.md`** — read this first to understand the project's domain language, key concepts, stakeholders, and glossary. Skills such as `improve-codebase-architecture`, `diagnosing-bugs`, and `tdd` consult this file before making design or debugging decisions.
...
- This repo does not yet have a `CONTEXT.md` or `docs/adr/`. They will be consulted automatically once created.
