...
# A biological sample IS a Sample (a cell-line entity), so it keeps the
# material outline and colour; only the wording narrows to this view's own.
_LG_CELLLINE = _lg("material", "Biological sample")
...
_VIEWS: tuple[tuple[str, str, str], ...] = (
    ...
    ("mv-cell", "p-cell", "Biological Samples"),
...
def _render_graph_views_section(
    ...
    result produced* (provenance), *what was tested* (molecular entities, biological samples),
