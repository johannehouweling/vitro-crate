...
def _embed_maturity_report(crate: ROCrate, state: CrateState) -> None:
    ...
    from the crate's current ``@graph``), FAIR + DSM, MIT coverage, and
    ...
    crate.add(
        File(
            ...
            properties={
                ...
                "description": (
                    "Profile adherence, FAIR/DSM, MIT coverage, and "
                    "Bridge2AI AI-readiness for this crate, generated by vitro-crate."
                ),
