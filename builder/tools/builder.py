    ...
    crate.add(
        File(
            ...
            properties={
                ...
                # We hold the bytes, so state them. Unlike the maturity report,
                # this diagram is rendered from the crate's ENTITIES and not from
                # any validation result, so its size is knowable without asking
                # what the validator thought.
                "contentSize": str(len(mermaid.encode("utf-8"))),
